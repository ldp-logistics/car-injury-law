      ...
      <div className="bg-white/90 backdrop-blur border border-gray-200 shadow-lg rounded-lg p-3 animate-in slide-in-from-left duration-700 fade-in">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-bold text-primary">$1,250,000 <span className="text-xs font-normal text-gray-400">- <Link href={internalLink("practice-areas/truck-accident")} className="text-black hover:underline font-semibold">Truck Accident</Link></span></p>
          </div>
        </div>
      </div>
    </div>
