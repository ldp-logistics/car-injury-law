      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg text-slate-700 max-w-none space-y-8">
            ...
            <div>
              <p>
                If you or a loved one has recently been involved in a serious incident in <strong>{location}</strong>, finding the right <strong>{keywords[0]}</strong> is likely the most important decision you will face this year. The aftermath of an accident—whether it’s a collision on {location} highways or a workplace injury—can be overwhelming. Medical bills pile up, insurance adjusters start calling, and physical pain can make it impossible to think clearly.
              </p>
              <p>
