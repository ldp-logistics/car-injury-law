            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                  Property owners have a legal duty to maintain safe premises. When they fail and 
                  you're injured, we prove their negligence and fight for the compensation you 
                  deserve. Hidden hazards don't stay hidden from us.
                </p>
              </motion.div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none text-muted-foreground">
                <p className="text-lg leading-relaxed mb-6">
                  <strong>Premises liability</strong> is the legal principle that holds property 
                  owners responsible for injuries caused by unsafe conditions on their property. 
                  Whether it's a grocery store, office building, apartment complex, or private 
                  home, owners must maintain a safe environment for visitors.
                </p>
                ...
                <div className="grid md:grid-cols-3 gap-6 my-10">
                  <Card className="border-l-4 border-l-secondary">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-bold text-primary text-lg mb-2">Duty to Inspect</h3>
                      <p className="text-muted-foreground text-sm">
                        Property owners must regularly inspect their premises to identify and 
                        address potential hazards before someone gets hurt.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-l-4 border-l-secondary">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-bold text-primary text-lg mb-2">Duty to Warn</h3>
                      <p className="text-muted-foreground text-sm">
                        When hazards can't be immediately fixed, owners must warn visitors with 
                        signs, barriers, or other clear notifications of the danger.
                      </p>
                    </CardContent>
                  </Card>
                ...
                <p className="text-lg leading-relaxed">
                  Common slip and fall hazards include wet floors, icy walkways, broken stairs, 
                  torn carpeting, poor lighting, uneven surfaces, and debris in walkways. We 
                  investigate every aspect of your accident to prove the owner's negligence.
                </p>
              </div>
            </div>
          </div>
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-shadow duration-300 bg-white">
                    <CardContent className="p-8">
                      ...
                      <h3 className="text-xl font-bold text-primary mb-4">Commercial General Liability (CGL)</h3>
                      <p className="text-muted-foreground leading-relaxed mb-4">
                        Businesses carry CGL policies that cover injuries to customers, vendors, 
                        and visitors on their premises. These policies typically have substantial 
                        coverage limits to protect against slip and fall claims.
                      </p>
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-shadow duration-300 bg-white border-2 border-secondary">
                    <CardContent className="p-8">
                      ...
                      <h3 className="text-xl font-bold text-primary mb-4">Homeowners Insurance</h3>
                      <p className="text-muted-foreground leading-relaxed mb-4">
                        Private residences are covered by homeowners or renters insurance policies. 
                        These policies include liability coverage for injuries to guests and 
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                  <Card className="h-full bg-gradient-to-br from-primary to-slate-800 text-white">
                    <CardContent className="p-8">
                      <Camera className="h-12 w-12 text-secondary mb-6" />
                      <h3 className="text-2xl font-bold mb-4">Hazard Documentation</h3>
                      <p className="text-gray-300 leading-relaxed mb-6">
                        We thoroughly document the dangerous condition that caused your fall—wet 
                        floors, broken stairs, icy sidewalks, torn carpet, or poor lighting. This 
                        evidence is crucial to proving negligence.
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-secondary flex-shrink-0" />
                          <span>Scene photographs and measurements</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-secondary flex-shrink-0" />
                          <span>Surveillance footage acquisition</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-secondary flex-shrink-0" />
                ...
                >
                  <Card className="h-full bg-gradient-to-br from-secondary/90 to-amber-600 text-primary">
                    <CardContent className="p-8">
                      ...
                      <h3 className="text-2xl font-bold mb-4">Proving Owner Notice</h3>
                      <p className="text-primary/80 leading-relaxed mb-6">
                        A key element in premises liability is proving the owner knew or should 
                        have known about the hazard. We investigate maintenance logs, inspection 
                        records, and prior complaints to establish notice.
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                          <span>Maintenance and cleaning logs</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                          <span>Prior incident reports</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                          <span>Employee testimony</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
                  We specialize in uncovering "hidden" negligence in property cases—the 
                  maintenance failures and safety violations that property owners try to conceal.
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-3">Uncovering Hidden Negligence</h3>
                  <p className="text-gray-400 leading-relaxed">
                    Property owners often hide evidence of known hazards. We dig deep into 
                    maintenance records, employee communications, and prior complaints to 
                    expose their negligence.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    Premises liability laws vary by state. Our nationwide network ensures 
                    you have attorneys who understand the specific standards and statutes 
              ...
              >
                ...
                <p className="text-gray-400 leading-relaxed max-w-2xl mx-auto">
                  Evidence in slip and fall cases can disappear quickly—floors get cleaned, 
                  conditions get fixed, and surveillance footage gets overwritten. Contact 
                  us immediately to preserve your case.
                </p>
              </motion.div>
            </div>
          </div>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              >
                ...
                <p className="text-muted-foreground mt-4">
                  Fill out the form below and one of our slip and fall attorneys will 
                  ...
                  <CardContent className="p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Textarea
                          id="caseDetails"
                          placeholder="Please describe where you fell, what caused it, and your injuries..."
