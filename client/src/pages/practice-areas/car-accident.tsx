    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                  ...
                  try to minimize your claim, our experienced attorneys stand by your side to ensure 
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none text-muted-foreground">
                <p className="text-lg leading-relaxed mb-6">
                  When you're involved in a car accident, having experienced legal representation can make 
                  all the difference in your case outcome. Our team of dedicated car accident attorneys 
                  brings decades of combined experience to every case we handle.
                </p>
                ...
                <div className="grid md:grid-cols-3 gap-6 my-10">
                  <Card className="border-l-4 border-l-secondary">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-bold text-primary text-lg mb-2">Crash Site Investigation</h3>
                      <p className="text-muted-foreground text-sm">
                        We conduct thorough investigations of accident scenes, documenting evidence 
                        that proves liability and supports your claim.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-l-4 border-l-secondary">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-bold text-primary text-lg mb-2">Police Report Analysis</h3>
                      <p className="text-muted-foreground text-sm">
                        We obtain and analyze official police reports to identify key details 
                        and inconsistencies that strengthen your case.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-l-4 border-l-secondary">
                    <CardContent className="p-6">
                      <Gavel className="h-10 w-10 text-secondary mb-4" />
                      <h3 className="font-bold text-primary text-lg mb-2">Proving Negligence</h3>
                      <p className="text-muted-foreground text-sm">
                        We build compelling cases proving driver negligence—speeding, distracted 
                        driving, drunk driving, and other reckless behaviors.
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  We're prepared to counter their strategies with solid evidence and aggressive 
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-shadow duration-300 bg-white">
                    <CardContent className="p-8">
                      ...
                      <h3 className="text-xl font-bold text-primary mb-4">Liability Coverage</h3>
                      <p className="text-muted-foreground leading-relaxed">
                        Liability coverage pays for damages you cause to others in an accident. 
                        We pursue claims against at-fault drivers' liability policies to cover 
                  ...
                  <Card className="h-full hover:shadow-xl transition-shadow duration-300 bg-white border-2 border-secondary">
                    <CardContent className="p-8">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        ...
                        all PIP benefits you're entitled to.
                      </p>
                      <ul className="mt-4 space-y-2">
                        <li className="flex items-start gap-2 text-sm text-muted-foreground">
                          <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-shadow duration-300 bg-white">
                    <CardContent className="p-8">
                      ...
                      <h3 className="text-xl font-bold text-primary mb-4">Uninsured Motorist Coverage</h3>
                      <p className="text-muted-foreground leading-relaxed">
                        When you're hit by a driver without insurance or with insufficient coverage, 
                        your own uninsured/underinsured motorist policy can cover your losses. We 
                        maximize these claims for our clients.
                      </p>
                      <ul className="mt-4 space-y-2">
                        <li className="flex items-start gap-2 text-sm text-muted-foreground">
                          <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                  <Card className="h-full bg-gradient-to-br from-primary to-slate-800 text-white">
                    <CardContent className="p-8">
                      <Phone className="h-12 w-12 text-secondary mb-6" />
                      <h3 className="text-2xl font-bold mb-4">Insurance Communication</h3>
                      <p className="text-gray-300 leading-relaxed mb-6">
                        We handle all communication with insurance adjusters so you don't have to. 
                        Insurance companies are trained to minimize payouts—we know their tactics 
                        and protect you from making statements that could hurt your case.
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-secondary flex-shrink-0" />
                          <span>Direct adjuster negotiations</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-secondary flex-shrink-0" />
                          <span>Recorded statement protection</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-secondary flex-shrink-0" />
                  ...
                  <Card className="h-full bg-gradient-to-br from-secondary/90 to-amber-600 text-primary">
                    <CardContent className="p-8">
                      ...
                      <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        receive full compensation. Insurance companies often undervalue claims—we 
                        fight for what you actually deserve.
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                          <span>Total medical expenses (past & future)</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                          <span>Property damage assessment</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                          <span>Lost wages & earning capacity</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                          <span>Pain and suffering valuation</span>
                        </li>
                      </ul>
                    </CardContent>
                  </Card>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    Our network of experienced car accident attorneys spans across the entire 
                    United States. No matter where your accident occurred, we have local 
                    expertise to handle your case effectively.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    ...
                    This means we're fully invested in getting you the maximum compensation 
                ...
                >
                  ...
                  <p className="text-gray-400 leading-relaxed">
                    Accidents don't wait for business hours, and neither do we. Our legal team 
                    is available around the clock to answer your questions and start building 
            ...
            <div className="max-w-2xl mx-auto">
              ...
              >
                ...
                <p className="text-muted-foreground mt-4">
                  Fill out the form below and one of our experienced car accident attorneys will 
        ...
        <section className="py-12 bg-slate-50 border-t border-slate-200">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl font-bold font-serif text-primary mb-8 text-center">
              Car Accident Lawyers Serving All 50 States
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {Object.values(STATE_DATA).map((state) => (
                ...
                >
                  Car Accident Lawyers in {state.name}
                </Link>
              ))}
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <SeoContentSection service="Car Accident Lawyer" location="Nationwide" />
        </div>
      </main>
